...
extension Optional where Wrapped: Encodable {
    public func save(_ key: String? = nil, using userDefaults: UserDefaults = .standard) {
        if let self = self {
...
extension Optional where Wrapped: Decodable {
    public static func load(_ key: String? = nil, using userDefaults: UserDefaults = .standard) -> Optional<Wrapped> {
        return Wrapped.load(key, using: userDefaults)
    }
}

extension Array where Element: Decodable {
    public static func load(_ key: String? = nil, using userDefaults: UserDefaults = .standard) -> Array<Element> {
        return Array<Element>.load(key, using: userDefaults) ?? []
    }
}

extension UserDefaults {
    public func setCodable<T: Codable>(_ object: T, forKey key: String) {
...
extension Decodable {
    public static func load(_ key: String? = nil, using userDefaults: UserDefaults = .standard) -> Self? {
